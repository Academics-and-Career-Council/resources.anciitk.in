    ...
    <>
      <div className="section section-nucleo-icons">
        <Container>
          <Row >
            ...
            <Col lg="6" md="12">
              <div className="icons-container">
                ...
                <i className="now-ui-icons clothes_tie-bow" id="international-relations"></i>
          ...
          <Row >
            <Col lg="6" md="12">
              <h2 className="title">UG Academics Wing</h2>
              <h5 className="description">
              The UG/PG Academics wing takes up the responsibility of
               the academics related work of the Academic and Career Council. 
               It acts as an interface between the institute policy makers and 
          ...
          <Row id="research-wing">
            ...
            <Col lg="6" md="12">
              <h2 className="title">Research Wing</h2>
              <h5 className="description">
              The Research Wing of the council aims at
               cultivating and promoting research 
               interests in the student community, by
                providing the freedom and opportunities
